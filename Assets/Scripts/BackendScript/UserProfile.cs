    ...
    public static User[] GetUsersSync(string deviceID)
{
   ...
   public static IEnumerator GetorCreateUser(string deviceId, string name, string profilePicture, string isMusicEnabled, string isSoundEnabled, System.Action<string> onSuccess, System.Action<string> onError)
{
    string queryParams = $"{azureFunctionAuthenticationParams}&deviceId={deviceId}&name={name}&profilePicture={profilePicture}&isMusicEnabled={isMusicEnabled}&isSoundEnabled={isSoundEnabled}";
    string url = $"{baseAzureFunctionUrl}?{queryParams}";
